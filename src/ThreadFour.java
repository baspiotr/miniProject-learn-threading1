...
public class ThreadFour implements Runnable {
    ...
    ThreadFour() {
        thread = new Thread(this, "four litters");
        thread.start();
    }
    ...
    public void run() {
        ...
        while (!MyCommunicate.getStatementReceived().equals("END")) {
            ...
            if (old != MyCommunicate.getStatementReceived() && MyCommunicate.getStatementReceived() != "END" && MyCommunicate.getStatementReceived() != null) {
                ...
                Result r = new Result(MyCommunicate.getStatementReceived(), MyCommunicate.getStatementReceived().toUpperCase(), 4, new Date().toString());
        ...
        if (MyCommunicate.getStatementReceived() == "END") {
            ...
            System.out.println("lastcase 4 latch= " + MyCommunicate.latch.getCount());
